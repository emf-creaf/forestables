...
#'
#' @section Parallel:
#'   Processing the plots from within an IFN version can be done in parallel (\code{forestables} uses
...
#'   will allow \code{ifn_to_tibble} to use parallelization when retrieving the data.
#'
