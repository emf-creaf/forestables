...
# For this we can't use testthat::skip_* functions, because this is the setup file
# not a test file, and the skip_* functions raises errors here instead of silently
# exit.
# SO we use an envvar in an if statement

if (identical(Sys.getenv("full_testing"), "true")) {
