...
# test data -----------------------------------------------------------------------------------
test_ifn2_plots <- ifn_plots_thesaurus |>
  dplyr::filter(
    PROVINCIA %in% c(
    ...
    ESTADILLO %in% (c(
      c(19,80,1120), c(11,444,1839), c(626,1021,23), c(233,5,445), c(61, 14, 328),
      c(2064,1138,325), c(679,114,499), c(3374,261), c(156,1463,377), c(51, 419,783),
      c(2003,629,2944), c(269,1460,444), c(90, 190,537), c(78,1223,1057), c(818,283,1483),
      c(135,761,1518), c(672,426,1557), c(412,1216,1728), c(172, 479,744), c(105,99,532),
      c(1406115, 0)
...
test_ifn3_plots <- ifn_plots_thesaurus |>
  dplyr::filter(
    PROVINCIA %in% c(
      "01", "02", "03", "04", "05", "06", "07", "10", "12", "13", "17",
      "23", "27", "30", "33", "31", "38", "40", "50", "49"
...
test_ifn4_plots <- ifn_plots_thesaurus |>
  dplyr::filter(
    PROVINCIA %in% c(
      "01", "02", "03", "04", "05", "06", "07", "10", "12", "13", "17",
      "23", "27", "30", "33", "31", "38", "40", "50", "49"
...
#       test_input$plot_table[nrow(test_ifn3_input)-2],
#       test_input$coord_table[nrow(test_ifn3_input)-2],
#       test_version,
#       test_input$plots[nrow(test_ifn3_input)-2],
#       test_input$province[nrow(test_ifn3_input)-2],
#       test_provinces_dictionary
#     )),
#     "tbl"
#   )
...
#   expect_s3_class(
#     test_error <- suppressWarnings(ifn_plot_table_process(
#       test_input$plot_table[nrow(test_ifn3_input)],
#       test_input$coord_table[nrow(test_ifn3_input)],
#       test_version,
#       test_input$plots[nrow(test_ifn3_input)],
#       test_input$province[nrow(test_ifn3_input)],
#       test_provinces_dictionary
#     )),
#     "tbl"
#   )
...
#
#   expect_identical(
#     unique(test_res$PLOT) |> as.character(),
#     test_input$plots[6] |>
#       as.character() |>
#       stringr::str_pad(width = 4, side = "left", pad = "0")
#   )
...
#   expect_s3_class(
#     test_error <- suppressWarnings(ifn_plot_table_process(
#       test_input$plot_table[11],
#       test_input$coord_table[11],
#       test_version,
#       test_input$plots[11],
...
#   expect_false("tururu" %in% unique(test_res$province_code))
#   expect_identical(nrow(test_res), 16L)
#
#   # ### missing random files
#   # # we test here what happens when some files are missing (ARBRE, ECOLOGIE...)
#   # to do:
