...
This table provides information for each tree 1 inch in diameter and larger found on a microplot, subplot, or core optional macroplot.
...
-   <div>
    ...
    ![](images/clipboard-3830948102.png){width="324"}
...
Shrub data is obtained from : "\_SEEDLING.csv" .
...
Saplings-\> diameter between 1 and 5.9 inches (TREE TABLE)
