...
-   IFN 3: Field data bases (Access 2007 \*.accdb)
    ...
    Data is organized in provinces and each province has one "access" file. Within the access files there are thematic sheets with similar names.
...
+---------------------+--------------------+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------+
|                     | RUMBO              | Rumbo                 | Bearing measured from the center of the plot to the tree in question, in gradian degrees. The measurement starts from north and proceeds clockwise. |
+---------------------+--------------------+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------+
| distance            | DISTANCI           | Distanci              | Distance, in meters parallel to the ground, from the center of the plot to the tree.                                                                |
|                     |                    |                       |                                                                                                                                                     |
|                     |                    |                       | (see ifn3 documentation)                                                                                                                            |
+---------------------+--------------------+-----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------+

The mean of diameters is calculated to obtain the variable dbh (diameter), and it is converted to cm.
...
\
The final variables provided are *id_unique_code*, *province_code*, *class*, *subclass*, *plot*, *sp_code*, *sp_name*, *tree_id*, *wood_quality*, *cubing_form*, *tree_ifn2*, *tree_ifn3*, *tree_ifn4*, *dbh*, *height* and *density_factor*.
