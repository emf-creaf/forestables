...
For the French forest inventory (FFI), we are going to select all forest plots of the Mediterranean area
sampled in 2012. First step is to select the departments corresponding to the Mediterranean area.
...
Now we can visualize the geographic distribution of plots selected:
...
It seems like we have the plots that we need, so we are going to create a *filter list*
...
Now that we have the forest inventory plots selected, we can create a *filter list*
